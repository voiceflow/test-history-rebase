...
app.post('/marketplace/user_module/:skill_id/:module_id', ensureLoggedIn(), Marketplace.giveAccess)
app.get('/marketplace/user_module/:skill_id/:module_id', ensureLoggedIn(), Marketplace.hasAccess)
