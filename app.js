...
app.post('/marketplace/cert/:project_id', ensureLoggedIn(), Marketplace.requestCertification)
app.put('/marketplace/cert/:project_id', ensureAdmin(), Marketplace.giveCertification)
app.delete('/marketplace/cert/:project_id', ensureLoggedIn(), Marketplace.cancelCertification)
