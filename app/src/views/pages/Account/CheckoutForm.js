  ...
  renderStage(){
    if(this.state.error){
      return <div className="pt-3">
        ...
        <Button className="exit" color="primary" block onClick={()=>{
          this.setState({
            error: null,
            stage: 0
          })
        ...
        <form onSubmit={this.handleSubmit} className={this.state.stage === 0 ? '' : 'd-none'}>
            ...
            <div>
              ...
              <div className="billing-info mb-3">
                <Input name="name" placeholder="Full Name" onChange={this.handleChange} value={this.state.name} maxLength={64} required/>
                <Input name="street" placeholder="Address Line 1" onChange={this.handleChange} value={this.state.street} maxLength={128} required/>
                <Input name="street2" placeholder="Address Line 2" onChange={this.handleChange} value={this.state.street2} maxLength={64}/>
                <div className="d-flex">
                  <Input type="select" name="country" placeholder="Country" onChange={this.handleChange} value={this.state.country} className="mr-2" required>
                    <option disabled value="">Country</option>
                    {countries.map((country, i) => <option key={i} value={country.code}>{country.name}</option>)}
                  </Input>
                  <Input name="city" placeholder="City" onChange={this.handleChange} value={this.state.city} className="mr-2" required/>
                  <Input name="state" placeholder="State/Province" onChange={this.handleChange} value={this.state.state} className="mr-2" required/>
                </div>
              </div>
              <label>
                Card details
            ...
            <div className="text-center small mt-2"><span className="text-muted">All payments are secure and handled with</span> <a href="https://stripe.com" target="_blank" rel="noopener noreferrer">Stripe</a></div>
        </form>
      </div>
    );
  }
