            ...
            <div>
                <InputGroup className="my-3">
                    <label className="input-group-text w-100 m-0 text-left">
                        <Input addon type="checkbox" disabled={this.props.locked} checked={!!this.state.node.extras.smart} onChange={this.handleInputChange}/>
                        <span className="ml-2">No duplicates</span>
                    </label>
                  </InputGroup>
                <div><button className="btn btn-clear btn-lg btn-block" disabled={this.props.locked} onClick={this.handleAddPath}>Add Path <i className="fas fa-plus-circle ml-1"></i></button></div>
