...
import { Alert, Button, Modal, SectionV2, Spinner, Text, toast } from '@voiceflow/ui';
...
import { useAddSeatsCheckoutPayment } from './AddSeats.hook';

export const AddSeats = manager.create(
  'BillingAddSeats',
  () =>
    ({ api, type, opened, hidden, animated, closePrevented }) => {
      ...
      const unitPrice = subscription?.additionalSeatsUnitAmount ?? 0;
            ...
            <>
              <SectionV2.SimpleSection headerProps={{ topUnit: 0, bottomUnit: 2 }}>
                <SectionV2.Description secondary lineHeight="20px">
                  Your organization currently has {numberOfSeats} Editor {pluralize('seat', numberOfSeats)}. Seats you
