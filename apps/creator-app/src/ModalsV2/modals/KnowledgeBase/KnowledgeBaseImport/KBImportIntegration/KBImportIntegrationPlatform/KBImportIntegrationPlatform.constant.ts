...
import type { KBImportIntegrationPlatformItem } from './KBImportIntegrationPlatform.interface';
...
export const INTEGRATION_PLATFORMS_MAPPER: Record<
  BaseModels.Project.IntegrationTypes,
  KBImportIntegrationPlatformItem
> = {
...
export const INTEGRATION_MANAGE_PLATFORMS_MAPPER: Record<
  BaseModels.Project.IntegrationTypes,
  KBImportIntegrationPlatformItem
> = {
