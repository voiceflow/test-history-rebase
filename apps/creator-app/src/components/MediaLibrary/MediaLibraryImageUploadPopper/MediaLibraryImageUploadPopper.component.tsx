...
export const MediaLibraryImageUploadPopper: React.FC<IMediaLibraryImageUploader> = ({ onClose, imageUrl, onImageSelect, onLibraryClick }) => {
  return (
    <Surface width="300px" pt={16} pb={24} px={24}>
      <MediaLibraryImageUploader onClose={onClose} imageUrl={imageUrl} onImageSelect={onImageSelect} onLibraryClick={onLibraryClick} />
    </Surface>
  );
};
