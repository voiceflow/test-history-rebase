...
import type { IResponseMessageInput } from './ResponseMessageInput.interface';

export const ResponseMessageInput = forwardRef<SlateEditorRef, IResponseMessageInput>('ResponseMessageInput')((
  {
    toolbar,
    placeholder = { default: 'Enter agent message', focused: '‘{‘ to add variable' },
