...
import { CustomScrollbars as UICustomScrollbars, setRef } from '@voiceflow/ui';
...
const CustomScrollbars = React.forwardRef<HTMLDivElement, CustomScrollbarsTypes.Props>(
