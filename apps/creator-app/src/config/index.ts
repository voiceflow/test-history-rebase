...
declare global {
  interface Window {
    ...
    VF_OVERRIDE_LOGROCKET_ENABLED?: boolean;
...
export const GOOGLE_SERVICE_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_GOOGLE_SERVICE_ENDPOINT === '' ? GOOGLE_SERVICE_LOCAL_ENDPOINT : GOOGLE_SERVICE_CLOUD_ENDPOINT;
...
const LOGROCKET_ENABLED_VAR = window.VF_OVERRIDE_LOGROCKET_ENABLED || process.env.LOGROCKET_ENABLED || process.env.VF_OVERRIDE_LOGROCKET_ENABLED;
