...
// chargebee
export const CHARGEBEE_SITE = window.VF_OVERRIDE_CHARGEBEE_SITE || process.env.VF_OVERRIDE_CHARGEBEE_SITE || process.env.CHARGEBEE_SITE!;
export const CHARGEBEE_PUBLISHABLE_KEY =
  window.VF_OVERRIDE_CHARGEBEE_PUBLISHABLE_KEY || process.env.VF_OVERRIDE_CHARGEBEE_PUBLISHABLE_KEY || process.env.CHARGEBEE_PUBLISHABLE_KEY!;

// partnerstack
export const PARTNER_STACK_PUBLIC_KEY =
  window.VF_OVERRIDE_PARTNER_STACK_PUBLIC_KEY || process.env.VF_OVERRIDE_PARTNER_STACK_PUBLIC_KEY! || process.env.PARTNER_STACK_PUBLIC_KEY;
