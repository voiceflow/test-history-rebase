...
declare global {
  interface Window {
    ...
    VF_OVERRIDE_PARTNER_STACK_PUBLIC_KEY?: string;
  }
}
...
export const IS_PRIVATE_CLOUD = window.VF_OVERRIDE_IS_PRIVATE_CLOUD
  ? window.VF_OVERRIDE_IS_PRIVATE_CLOUD === 'true'
  : CLOUD_ENV !== PUBLIC_CLOUD;
...
export const LOG_LEVEL = (
  IS_PRODUCTION && !IS_E2E ? 'error' : process.env.LOG_LEVEL || 'info'
) as loglevel.LogLevelDesc;
...
// maintenance
export const MAINTENANCE_STATUS_SOURCE =
  window.VF_OVERRIDE_MAINTENANCE_STATUS_SOURCE || process.env.MAINTENANCE_STATUS_SOURCE!;

// copy-paste
export const COPY_PASTE_KEY = window.VF_OVERRIDE_COPY_PASTE_KEY || process.env.COPY_PASTE_KEY!;

// userflow
export const USERFLOW_TOKEN =
  (IS_PRODUCTION_ENV && (window.VF_OVERRIDE_USERFLOW_TOKEN || process.env.USERFLOW_TOKEN)) || null;

// canvas export
export const CANVAS_EXPORT_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_CANVAS_EXPORT_ENDPOINT ||
  process.env.VF_OVERRIDE_CANVAS_EXPORT_ENDPOINT ||
  process.env.CANVAS_EXPORT_CLOUD_ENDPOINT!;
export const CANVAS_EXPORT_LOCAL_ENDPOINT = process.env.CANVAS_EXPORT_LOCAL_ENDPOINT!;
export const CANVAS_EXPORT_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_CANVAS_EXPORT_ENDPOINT === ''
    ? CANVAS_EXPORT_LOCAL_ENDPOINT
    : CANVAS_EXPORT_CLOUD_ENDPOINT;

// platform services
export const ALEXA_SERVICE_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_ALEXA_SERVICE_ENDPOINT ||
  process.env.VF_OVERRIDE_ALEXA_SERVICE_ENDPOINT ||
  process.env.ALEXA_SERVICE_CLOUD_ENDPOINT!;
export const ALEXA_SERVICE_LOCAL_ENDPOINT = process.env.ALEXA_SERVICE_LOCAL_ENDPOINT!;
export const ALEXA_SERVICE_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_ALEXA_SERVICE_ENDPOINT === ''
    ? ALEXA_SERVICE_LOCAL_ENDPOINT
    : ALEXA_SERVICE_CLOUD_ENDPOINT;

export const GENERAL_SERVICE_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_GENERAL_SERVICE_ENDPOINT ||
  process.env.VF_OVERRIDE_GENERAL_SERVICE_ENDPOINT ||
  process.env.GENERAL_SERVICE_CLOUD_ENDPOINT!;
...
export const GENERAL_SERVICE_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_GENERAL_SERVICE_ENDPOINT === ''
    ? GENERAL_SERVICE_LOCAL_ENDPOINT
    : GENERAL_SERVICE_CLOUD_ENDPOINT;

export const RUNTIME_API_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_RUNTIME_API_ENDPOINT ||
  process.env.VF_OVERRIDE_RUNTIME_API_ENDPOINT ||
  process.env.RUNTIME_API_CLOUD_ENDPOINT!;
export const RUNTIME_API_LOCAL_ENDPOINT = process.env.RUNTIME_API_LOCAL_ENDPOINT!;
export const RUNTIME_API_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_RUNTIME_API_ENDPOINT === ''
    ? RUNTIME_API_LOCAL_ENDPOINT
    : RUNTIME_API_CLOUD_ENDPOINT;

export const GENERAL_RUNTIME_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_GENERAL_RUNTIME_ENDPOINT ||
  process.env.VF_OVERRIDE_GENERAL_RUNTIME_ENDPOINT ||
  process.env.GENERAL_RUNTIME_CLOUD_ENDPOINT!;
...
export const GENERAL_RUNTIME_ENDPOINT =
  ...
  (IS_E2E && process.env.VF_OVERRIDE_GENERAL_RUNTIME_ENDPOINT === ''
    ? GENERAL_RUNTIME_LOCAL_ENDPOINT
    : GENERAL_RUNTIME_CLOUD_ENDPOINT);

export const IDENTITY_API_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_IDENTITY_API_ENDPOINT ||
  process.env.VF_OVERRIDE_IDENTITY_API_ENDPOINT ||
  process.env.IDENTITY_API_CLOUD_ENDPOINT!;
export const IDENTITY_API_LOCAL_ENDPOINT = process.env.IDENTITY_API_LOCAL_ENDPOINT!;
export const IDENTITY_API_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_IDENTITY_API_ENDPOINT === ''
    ? IDENTITY_API_LOCAL_ENDPOINT
    : IDENTITY_API_CLOUD_ENDPOINT;

export const BILLING_API_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_BILLING_API_ENDPOINT ||
  process.env.VF_OVERRIDE_BILLING_API_ENDPOINT ||
  process.env.BILLING_API_CLOUD_ENDPOINT!;
export const BILLING_API_LOCAL_ENDPOINT = process.env.BILLING_API_LOCAL_ENDPOINT!;
export const BILLING_API_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_BILLING_API_ENDPOINT === ''
    ? BILLING_API_LOCAL_ENDPOINT
    : BILLING_API_CLOUD_ENDPOINT;

export const AUTH_API_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_AUTH_API_ENDPOINT ||
  process.env.VF_OVERRIDE_AUTH_API_ENDPOINT ||
  process.env.AUTH_API_CLOUD_ENDPOINT!;
export const AUTH_API_LOCAL_ENDPOINT = process.env.AUTH_API_LOCAL_ENDPOINT!;
export const AUTH_API_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_AUTH_API_ENDPOINT === '' ? AUTH_API_LOCAL_ENDPOINT : AUTH_API_CLOUD_ENDPOINT;

export const ANALYTICS_API_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_ANALYTICS_API_ENDPOINT ||
  process.env.VF_OVERRIDE_ANALYTICS_API_ENDPOINT ||
  process.env.ANALYTICS_API_CLOUD_ENDPOINT!;
export const ANALYTICS_API_LOCAL_ENDPOINT = process.env.ANALYTICS_API_LOCAL_ENDPOINT!;
export const ANALYTICS_API_ENDPOINT =
  IS_E2E && process.env.VF_OVERRIDE_ANALYTICS_API_ENDPOINT === ''
    ? ANALYTICS_API_LOCAL_ENDPOINT
    : ANALYTICS_API_CLOUD_ENDPOINT;
...
const PRIVATE_LLM_MODEL_LIST =
  PRIVATE_LLM_MODEL_STRING?.split?.(',').filter((model) => VALID_MODELS.has(model)) || null;

export const PRIVATE_LLM_MODELS = new Set(PRIVATE_LLM_MODEL_LIST ?? []);

export const VOICEFLOW_CDN_ENDPOINT =
  window.VF_OVERRIDE_VOICEFLOW_CDN_ENDPOINT ||
  process.env.VF_OVERRIDE_VOICEFLOW_CDN_ENDPOINT ||
  'https://cdn.voiceflow.com';

// chargebee
export const CHARGEBEE_SITE =
  window.VF_OVERRIDE_CHARGEBEE_SITE || process.env.VF_OVERRIDE_CHARGEBEE_SITE || process.env.CHARGEBEE_SITE!;
export const CHARGEBEE_PUBLISHABLE_KEY =
  window.VF_OVERRIDE_CHARGEBEE_PUBLISHABLE_KEY ||
  process.env.VF_OVERRIDE_CHARGEBEE_PUBLISHABLE_KEY ||
  process.env.CHARGEBEE_PUBLISHABLE_KEY!;

// partnerstack
export const PARTNER_STACK_PUBLIC_KEY =
  window.VF_OVERRIDE_PARTNER_STACK_PUBLIC_KEY ||
  process.env.VF_OVERRIDE_PARTNER_STACK_PUBLIC_KEY! ||
  process.env.PARTNER_STACK_PUBLIC_KEY;
