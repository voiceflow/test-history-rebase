...
export const REQUEST_MORE_TOKENS_LINK =
...
// LEARN
export const NO_MATCH_LEARN_MORE = 'https://learn.voiceflow.com/hc/en-us/articles/11935516192909-Generative-No-Match';
export const PERSONAS_LEARN_MORE =
  'https://learn.voiceflow.com/hc/en-us/articles/7315471294605-Testing-with-Variables-Variable-States-Personas';
export const PARTIAL_IMPORT_LEARN_MORE = 'https://learn.voiceflow.com/hc/en-us/articles/16574928375949';
export const COMMAND_STEP_LEARN_MORE = 'https://voiceflow.zendesk.com/hc/en-us/articles/9175374738445-Commands';
...
export const CMS_KNOWLEDGE_BASE_LEARN_MORE =
  'https://learn.voiceflow.com/hc/en-us/articles/22213924437517-Knowledge-Base';
export const CMS_WORKFLOW_LEARN_MORE = 'https://learn.voiceflow.com/hc/en-us/articles/26163424619405-Workflows';
export const CMS_RESPONSE_LEARN_MORE = 'https://learn.voiceflow.com/hc/en-us/articles/22213924437517-Knowledge-Base';

export const TRIGGERS_LEARN_MORE = 'https://learn.voiceflow.com/hc/en-us/articles/27348063823501-Trigger';

export const LLM_INTENT_CLASSIFICATION_LEARN_MORE =
  'https://developer.voiceflow.com/docs/intent-classification-using-llms';
export const NLU_INTENT_CLASSIFICATION_LEARN_MORE =
  'https://developer.voiceflow.com/docs/intent-classification-using-nlu';

export const INTENT_PREVIEW_TIP_LEARN_LINK =
  'https://learn.voiceflow.com/hc/en-us/articles/22213856020237-Intents#h_01HHXBCE0P3TD5A1B0RAX783FZ';
