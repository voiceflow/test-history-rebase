...
import { ACTION_CONTEXT, LINK, MOCK_STATE, NODE_ID, PORT_ID } from '../creator.fixture';

const { createState, describeReducer, describeReverter } = createDuckTools(CreatorV2, MOCK_STATE);

describe('Ducks | Creator V2 - patchManyLinks reducer', () => {
  describeReducer(Realtime.link.patchMany, ({ applyAction }) => {
