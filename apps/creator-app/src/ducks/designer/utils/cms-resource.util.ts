...
export const getCMSResourceOneByIDSelector = (scope: FolderScope) =>
  match(scope)
    ...
    .with(FolderScope.MESSAGE, () => Response.selectors.oneByID)
...
export const getCMSResourceCountSelector = (scope: FolderScope) =>
  match(scope)
    ...
    .with(FolderScope.MESSAGE, () => Response.selectors.count)
...
export const getCMSResourceAllByIDsSelector = (scope: FolderScope) =>
  match(scope)
    ...
    .with(FolderScope.MESSAGE, () => Response.selectors.allByIDs)
...
export const getCMSResourceAllByFolderIDsSelector = (scope: FolderScope) =>
  match(scope)
    ...
    .with(FolderScope.MESSAGE, () => Response.selectors.allByFolderIDs)
