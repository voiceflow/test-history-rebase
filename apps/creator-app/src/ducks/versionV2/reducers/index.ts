...
const versionReducer = createRootCRUDReducer(INITIAL_STATE, crudReducers)
  .mimerCase(...addDiagram)
  .mimerCase(...removeDiagram)
  .mimerCase(...removeManyDiagrams)
  .mimerCase(...addGlobalVariable)
  .mimerCase(...addManyGlobalVariables)
  .mimerCase(...removeGlobalVariable)
  .mimerCase(...removeManyGlobalVariables)
  .mimerCase(...patchPublishing)
  .mimerCase(...patchSession)
  .mimerCase(...patchSettings)
  .mimerCase(...patchDefaultStepColors)
  .mimerCase(...reorderComponents)
  .mimerCase(...reloadGlobalVariables)
  .mimerCase(...reloadFolders)
  .mimerCase(...addManyComponents)
