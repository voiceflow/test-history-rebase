...
const AssistantCMS = () => {
  ...
  const { isEnabled: isCMSMessagesEnabled } = useFeature(Realtime.FeatureFlag.CMS_RESPONSES);
  ...
  return (
    <CMSLayout>
      <Switch>
        ...
        {isCMSMessagesEnabled && <Route path={Path.CMS_MESSAGE} component={AssistantCMSMessage} />}
