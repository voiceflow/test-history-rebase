...
export const cmsResourceActionsButtonFactory =
  (staticProps: Pick<ICMSResourceActionsButton, 'label' | 'iconName'>): React.FC<Omit<ICMSResourceActionsButton, 'label' | 'iconName'>> =>
  (props) =>
    <CMSResourceActionsButton {...props} {...staticProps} />;
