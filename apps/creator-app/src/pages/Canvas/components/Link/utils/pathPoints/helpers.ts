...
export const isSourceRectsReversed = ({ sourceNodeRect, sourcePortRect }: LinkedRects) =>
  sourcePortRect.left < sourceNodeRect.right;

export const getSourceXOffset = ({
  sourceNodeIsChip,
  sourceNodeIsAction,
}: {
  sourceNodeIsChip: boolean;
  sourceNodeIsAction: boolean;
}): number => (sourceNodeIsAction || sourceNodeIsChip ? 0 : NODE_LINK_WIDTH);

export const getSourceLeftXOffset = (options: GetPathPointsOptions): number =>
  options.sourceNodeIsStart ? 0 : getSourceXOffset(options);
...
export const getActionsSourceStartLeftX = (
  { sourcePortRect, sourceNodeRect }: LinkedRects,
  options: GetPathPointsOptions
): number => (options.sourceNodeIsAction ? sourcePortRect.left : sourceNodeRect.left) - getSourceLeftXOffset(options);
...
export const getSourceStartActionReversedLeftX = (
  { sourcePortRect }: LinkedRects,
  options: GetPathPointsOptions
): number => sourcePortRect.left - getSourceXOffset(options);

export const getSourceStartActionLeftX = (linkedRects: LinkedRects, options: GetPathPointsOptions): number =>
  isSourceRectsReversed(linkedRects)
    ? getSourceStartActionReversedLeftX(linkedRects, options)
    : getSourceStartNormalLeftX(linkedRects, options);

export const getSourceStartLeftX = (linkedRects: LinkedRects, options: GetPathPointsOptions): number =>
  options.sourceNodeIsAction
    ? getSourceStartActionLeftX(linkedRects, options)
    : getSourceStartNormalLeftX(linkedRects, options);
...
export const getTargetEndLeftY = (linkedRects: LinkedRects, options: GetPathPointsOptions): number =>
  getTargetEndY(linkedRects, options);
...
export const getTargetEndRightY = (linkedRects: LinkedRects, options: GetPathPointsOptions): number =>
  getTargetEndY(linkedRects, options);
...
export const isTargetEndLeftXToRightOfSourceNodeXCenter = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean => getTargetEndLeftX(linkedRects, options) > getSourceNodeXCenter(linkedRects);

export const isTargetEndLeftXToRightOfSourceStartRightXWithStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean =>
  getTargetEndLeftX(linkedRects, options) > getSourceStartRightX(linkedRects, options) + STRAIGHT_PATH_OFFSET;

export const isTargetEndLeftXToRightOfSourceStartLeftWithoutStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean =>
  getTargetEndLeftX(linkedRects, options) > getSourceStartLeftX(linkedRects, options) - STRAIGHT_PATH_OFFSET;

export const isTargetEndLeftXToRightOfSourceXCenterWithStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean => getTargetEndLeftX(linkedRects, options) > getSourceNodeXCenter(linkedRects) + STRAIGHT_PATH_OFFSET;

export const isTargetEndLeftXToRightOfSourceStartRightXWithDoubleStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean =>
  getTargetEndLeftX(linkedRects, options) > getSourceStartRightX(linkedRects, options) + DOUBLE_STRAIGHT_PATH_OFFSET;

export const isTargetEndRightXToRightOfSourceStartLeftXWithoutDoubleStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean =>
  getTargetEndRightX(linkedRects, options) > getSourceStartLeftX(linkedRects, options) - DOUBLE_STRAIGHT_PATH_OFFSET;
...
export const isTargetEndLeftXToRightOfSourceNodeXCenterWithStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean => getTargetNodeXCenter(linkedRects) > getSourceStartRightX(linkedRects, options) + STRAIGHT_PATH_OFFSET;

export const isTargetNodeXCenterToLeftOfSourceStartRightXWithStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean => getTargetNodeXCenter(linkedRects) > getSourceStartRightX(linkedRects, options) + STRAIGHT_PATH_OFFSET;

export const isTargetNodeXCenterToRightOfSourceStartLeftXWithStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean => getTargetNodeXCenter(linkedRects) > getSourceStartLeftX(linkedRects, options) + STRAIGHT_PATH_OFFSET;
...
export const isTargetNodeXCenterToRightOfSourceStartLeftXWithoutStraightOffset = (
  linkedRects: LinkedRects,
  options: GetPathPointsOptions
): boolean => getTargetNodeXCenter(linkedRects) > getSourceStartLeftX(linkedRects, options) - STRAIGHT_PATH_OFFSET;
