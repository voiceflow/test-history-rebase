...
const HelpTooltip: React.FC = () => (
  <>
    ...
    <Tooltip.Paragraph marginBottomUnits={3}>1. From the skill detail card in the Alexa app while enabling the skill.</Tooltip.Paragraph>
    ...
    <Tooltip.Paragraph marginBottomUnits={3}>
      This gives users flexibility – if the user skips the account linking step when enabling the skill, they can come back to it later, after making
      a request that requires the authentication.
    </Tooltip.Paragraph>
  </>
);
