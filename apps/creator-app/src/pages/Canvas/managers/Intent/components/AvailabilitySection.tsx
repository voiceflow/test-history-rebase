  ...
  return (
    <TippyTooltip
      ...
      content={
        <TippyTooltip.Multiline>
          ...
          {isEnabled
            ? "When toggled on, this intent acts as 'Global', meaning it can be triggered from anywhere in the agent."
    ...
    >
      <SectionV2.SimpleSection onClick={onChange}>
        <SectionV2.Title>Available from other workflows?</SectionV2.Title>
