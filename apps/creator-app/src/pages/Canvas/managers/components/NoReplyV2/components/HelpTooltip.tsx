...
const HelpTooltip: React.FC = () => (
  <>
    ...
    <Tooltip.Section marginBottomUnits={2}>
      ...
      determines how long the assistant will wait before sending the first no reply response. If you have multiple no
      reply responses, this will also be time between each no reply response- assuming the user continues to take no
      action.
    </Tooltip.Section>
