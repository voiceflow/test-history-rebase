...
import type * as RealtimeSDK from '@voiceflow/realtime-sdk';
...
interface DiagramHeartbeatProviderProps extends React.PropsWithChildren {
  context: ActiveDomainContext | ActiveVersionContext;
  diagramID: string | null;
  isSubscribed: boolean;
}

export const DiagramHeartbeatProvider: React.FC<DiagramHeartbeatProviderProps> = ({
  diagramID,
  context,
  children,
  isSubscribed,
  ...
  const lockEntities = React.useCallback(
    async (type: RealtimeSDK.diagram.awareness.LockEntityType, entityIDs: string[]) => {
  ...
  const unlockEntities = React.useCallback(
    async (type: RealtimeSDK.diagram.awareness.LockEntityType, entityIDs: string[]) => {
