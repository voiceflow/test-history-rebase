...
const NoIntent: React.FC<NoIntentProps> = ({ turnID, focused, utterance, onToggleIntentSelect }) => {
  ...
  // We have to put this in a useEffect because on intentSelect,
  // if it is builtIn, the intentSelect needs to create the intent first,
  // and there can be race conditions with the inner code
  useDidUpdateEffect(() => {
    if (targetIntentID) {
