...
import type { AnyAdapter, BaseKeyExtractor, CacheOptions, KeyOptions } from './strategy.interface';

export abstract class BaseStrategy<K extends BaseKeyExtractor, A extends AnyAdapter | undefined = undefined> {
