...
export type StringToDB<A extends BaseAdapter | undefined = undefined> = A extends BaseAdapter
  ? Parameters<A['toDB']>[0]
  : string;

export type StringFromDB<A extends BaseAdapter | undefined = undefined> = A extends BaseAdapter
  ? ReturnType<A['fromDB']>
  : string;

export type HashToDB<A extends BaseHashAdapter | undefined = undefined> = A extends BaseHashAdapter
  ? Parameters<A['toDB']>[0]
  : Hash;

export type HashFromDB<A extends BaseHashAdapter | undefined = undefined> = A extends BaseHashAdapter
  ? ReturnType<A['fromDB']>
  : Hash;
