...
export type CreateOneForUserData<T extends { createOneForUser: (userID: number, data: any) => any }> = Parameters<
  T['createOneForUser']
>[1];
export type CreateManyForUserData<T extends { createManyForUser: (userID: number, data: any[]) => any }> = Parameters<
  T['createManyForUser']
>[1];
...
export type PatchOneForUserData<T extends { patchOneForUser: (userID: number, id: any, data: any) => any }> =
  Parameters<T['patchOneForUser']>[2];
export type PatchManyForUserData<T extends { patchManyForUser: (userID: number, id: any, data: any[]) => any }> =
  Parameters<T['patchManyForUser']>[2];
