...
import { KBSettingsChunkStrategy, KBSettingsGptModel, KBSettingsPromptMode, KnowledgeBaseSettings } from '@voiceflow/dtos';
...
export class KnowledgeBaseSettingsService extends MutableService<KnowledgeBaseORM> {
  private DEFAULT_SETTINGS: KnowledgeBaseSettings = {
    summarization: {
      ...
      model: KBSettingsGptModel.GPT_3_5_turbo,
      temperature: 0.1,
      system:
