...
export class ResponseVariantLoguxController {
  ...
  @Authorize.Permissions<Actions.ResponseVariant.CreateTextMany.Request>(
  ...
  @UseRequestContext()
  async patchOneJSON(
    @Payload() { id, patch, context }: Actions.ResponseVariant.PatchOneJSON,
    @AuthMeta() auth: AuthMetaPayload
  ) {
  ...
  @UseRequestContext()
  async patchOneText(
    @Payload() { id, patch, context }: Actions.ResponseVariant.PatchOneText,
    @AuthMeta() auth: AuthMetaPayload
  ) {
  ...
  @UseRequestContext()
  async patchManyJSON(
    @Payload() { ids, patch, context }: Actions.ResponseVariant.PatchManyJSON,
    @AuthMeta() auth: AuthMetaPayload
  ) {
  ...
  @UseRequestContext()
  async patchManyText(
    @Payload() { ids, patch, context }: Actions.ResponseVariant.PatchManyText,
    @AuthMeta() auth: AuthMetaPayload
  ) {
  ...
  async deleteOne(@Payload() { id, context }: Actions.ResponseVariant.DeleteOne, @AuthMeta() auth: AuthMetaPayload) {
    ...
    await this.service.broadcastDeleteMany(
      { ...result, delete: { ...result.delete, responseVariants: [] } },
      { auth, context }
    );
  }
  ...
  @UseRequestContext()
  async replaceWithType(
    @Payload() { id, type, context }: Actions.ResponseVariant.ReplaceWithType,
    @AuthMeta() auth: AuthMetaPayload
  ) {
