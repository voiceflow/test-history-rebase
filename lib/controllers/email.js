...
class Email {
  ...
  async getTemplate(req, res) {
    const action = async () => {
      const [templateId] = this.services.hashids.decode(req.params.id);

      return this.services.emailManager.getTemplate(req.user.id, templateId);
    };
  ...
  async getTemplates(req, res) {
    const action = async () => {
      ...
      return this.services.emailManager.getTemplates(req.user.id, skillId);
    };
  ...
  async setTemplate(req, res) {
    const action = async () => {
      ...
      return this.services.emailManager.setTemplate(req.user.id, skillId, payload, templateId);
    };
  ...
  async deleteTemplate(req, res) {
    const action = async () => {
      ...
      return this.services.emailManager.deleteTemplate(req.user.id, templateId);
    };
