...
export class Migration20240617133004 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "designer"."response" add column "type" text check ("type" in (\'prompt\', \'message\')) null default \'message\';');
