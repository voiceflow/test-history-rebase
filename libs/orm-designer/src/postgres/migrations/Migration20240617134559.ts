...
export class Migration20240617134559 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "designer"."reference_resource" add constraint "reference_resource_type_check" check ("type" in (\'node\', \'intent\', \'prompt\', \'message\', \'diagram\', \'function\'));');
  }
