...
export const unlockEntities = Utils.protocol.createAction<LockUnlockEntityPayload>(
  diagramAwarenessType('UNLOCK_ENTITIES')
);
export const updateLockedEntities = Utils.protocol.createAction<UpdateLocksPayload>(
  diagramAwarenessType('UPDATE_LOCKED_ENTITIES')
);
