...
export const customPayloadOutPortsAdapter = createOutPortsAdapter<
  NodeData.CustomPayloadBuiltInPorts,
  NodeData.CustomPayload
>(
...
export const customPayloadOutPortsAdapterV2 = createOutPortsAdapterV2<
  NodeData.CustomPayloadBuiltInPorts,
  NodeData.CustomPayload
>(
