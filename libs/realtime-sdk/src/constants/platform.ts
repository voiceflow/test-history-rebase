...
const SUPPORTED_NLUS_MAP = Utils.array.createMap(Object.values(Platform.Constants.NLUType)) as Partial<
  Record<string, Platform.Constants.NLUType>
>;
...
const LEGACY_PLATFORM_TO_PROJECT_TYPE: Partial<
  Record<string, { type: Platform.Constants.ProjectType; platform: Platform.Constants.PlatformType }>
> = {
