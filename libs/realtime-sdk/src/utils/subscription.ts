...
export const findSwitchEntitlement = (entitlements: Identity.SubscriptionEntitlement[] | undefined, itemID: string) => {
...
export const findRangeEntitlement = (entitlements: Identity.SubscriptionEntitlement[] | undefined, itemID: string) => {
  const entitlement = entitlements?.find((entitlement) => entitlement.featureID === itemID);
