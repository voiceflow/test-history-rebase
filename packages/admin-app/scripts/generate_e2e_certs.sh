...
echo "LAN IP: $LAN_IP"
mkcert localhost 127.0.0.1 ::1 $(echo "$(hostname)" | tr '[:upper:]' '[:lower:]') $(hostname) $LAN_IP admin-local.development.voiceflow.com creator-local.development.voiceflow.com *.test.e2e;
