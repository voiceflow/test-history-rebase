import { Button, toast } from '@voiceflow/ui';
...
import { BetaUsersFullList, BetaUsersListSearch, BetaUsersListWrapper } from '@/pages/BetaProgram/styles';
...
const mapDispatchToProps = { getBetaUsers: Admin.getBetaUsers };

export default connect(null, mapDispatchToProps)(BetaUsersList);
