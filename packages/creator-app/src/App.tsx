...
import { AccountLoadingGate, FeatureLoadingGate, GlobalSocketSubscriptionsLoadingGate, RealtimeConnectionGate, SocketLoadingGate } from '@/gates';
...
export default compose(
  hot,
  withGlobalProviders,
  withBatchLoadingGate(FeatureLoadingGate, SocketLoadingGate, AccountLoadingGate, RealtimeConnectionGate, GlobalSocketSubscriptionsLoadingGate)
