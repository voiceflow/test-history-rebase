...
const ConditionsBuilderV2: React.FC<ConditionsBuilderV2Props> = ({ expression }) => {
  return (
    <Box pt={16} pb={16}>
      <Popper placement="left-start" renderContent={() => <ConditionsPopper expression={expression as Realtime.ExpressionV2} />}>
        {({ ref, onToggle }) => (
