...
export default function SlotPromptTooltip() {
  return (
    <>
      <Section marginBottomUnits={1.5}>Entity reprompts are the question we will ask the user to obtain a specific required entity.</Section>
      ...
      <Section>
        ...
        may trigger this intent and give us the <var>type</var> of pizza they’d like, but not mention the <var>size</var>. The entity reprompt is the
