...
const TRANSCRIPTS_MIGRATION_ONGOING = process.env.FF_TRANSCRIPTS_MIGRATION_ONGOING === 'true';
...
export const LOCAL_FEATURE_OVERRIDES: Partial<Record<FeatureFlag, boolean>> = {
  ...
  [FeatureFlag.TRANSCRIPTS_MIGRATION_ONGOING]: TRANSCRIPTS_MIGRATION_ONGOING,
  // canvas and editor updates
