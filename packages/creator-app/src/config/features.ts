...
const CANVAS_PREVIEW_ENABLED = process.env.FF_CANVAS_PREVIEW === 'true';
const STEP_EDITOR_UPDATES_ENABLED = process.env.FF_STEP_EDITOR_UPDATES === 'true';
...
export const LOCAL_FEATURE_OVERRIDES: Partial<Record<FeatureFlag, boolean>> = {
  ...
  [FeatureFlag.CANVAS_PREVIEW]: CANVAS_PREVIEW_ENABLED,
  [FeatureFlag.STEP_EDITOR_UPDATES]: STEP_EDITOR_UPDATES_ENABLED,
