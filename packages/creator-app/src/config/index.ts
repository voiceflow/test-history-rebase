...
export const REALTIME_ENDPOINT = window.VF_OVERRIDE_REALTIME_ENDPOINT || (IS_DEVELOPMENT ? REALTIME_LOCAL_ENDPOINT : REALTIME_CLOUD_ENDPOINT);
...
export const CANVAS_EXPORT_ENDPOINT =
  IS_DEVELOPMENT && process.env.VF_OVERRIDE_CANVAS_EXPORT_ENDPOINT === '' ? CANVAS_EXPORT_LOCAL_ENDPOINT : CANVAS_EXPORT_CLOUD_ENDPOINT;
...
export const GOOGLE_SERVICE_CLOUD_ENDPOINT =
  window.VF_OVERRIDE_GOOGLE_SERVICE_ENDPOINT || process.env.VF_OVERRIDE_GOOGLE_SERVICE_ENDPOINT || process.env.GOOGLE_SERVICE_CLOUD_ENDPOINT!;
...
export const GENERAL_RUNTIME_ENDPOINT =
  ...
  (IS_DEVELOPMENT && process.env.VF_OVERRIDE_GENERAL_RUNTIME_ENDPOINT === '' ? GENERAL_RUNTIME_LOCAL_ENDPOINT : GENERAL_RUNTIME_CLOUD_ENDPOINT);
