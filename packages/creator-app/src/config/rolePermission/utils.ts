import { AnyRolePermission } from './types';

type RolePermissionRecord<P extends AnyRolePermission<any>> = { [K in P['permission']]: Extract<P, { permission: K }> };

export const buildRolePermissionRecord = <P extends AnyRolePermission<any>>(permissions: ReadonlyArray<P>): RolePermissionRecord<P> =>
