...
export type DragContextType = null | {
  ...
  registerPreview: <T>(type: string, component: Nullable<React.OldFC<T & DragContextPreviewProps>>, options?: Partial<PreviewOptions>) => void;
};
...
export const DragProvider: React.OldFC = ({ children }) => {
  ...
  const registerPreview = <T extends any>(
    type: string,
    component: Nullable<React.OldFC<T & DragContextPreviewProps>>,
