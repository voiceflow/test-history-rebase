...
export const nodeByIDSelector = createSelector(
  ...
  ({ nodes }) =>
    (nodeID: string) =>
      getNormalizedByKey(nodes, nodeID)
);
...
export const allNodesByIDsSelector = createSelector(
  ...
  ({ nodes }) =>
    (nodeIDs: string[]) =>
      getAllNormalizedByKeys(nodes, nodeIDs)
);
...
export const linkByIDSelector = createSelector(
  ...
  ({ links }) =>
    (linkID: string) =>
      getNormalizedByKey(links, linkID)
);
...
export const allLinksByIDsSelector = createSelector(
  ...
  ({ links }) =>
    (linkIDs: string[]) =>
      getAllNormalizedByKeys(links, linkIDs)
);
...
export const portByIDSelector = createSelector(
  ...
  ({ ports }) =>
    (portID: string) =>
      getNormalizedByKey(ports, portID)
);
...
export const allPortsByIDsSelector = createSelector(
  ...
  ({ ports }) =>
    (portIDs: string[]) =>
      getAllNormalizedByKeys(ports, portIDs)
);
