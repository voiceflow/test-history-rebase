...
export enum SocketAction {
  ...
  REMOVE_MANY_OUT_BY_KEY_PORTS = 'REALTIME:SOCKET:PORT:REMOVE_MANY_OUT_BY_KEY',
...
export type RemoveManyOutByKeyPorts = Action<SocketAction.REMOVE_MANY_OUT_BY_KEY_PORTS, ActionPayload<Creator.RemoveManyOutByKeyPorts>>;
...
export type RemoveManyLinks = Action<SocketAction.REMOVE_MANY_LINKS, ActionPayload<Creator.RemoveManyLinks>>;
 ...
 * @deprecated
 */
export const addManyNodes = (entities: Realtime.EntityMap, position: Point): AddManyNodes =>
  createAction(SocketAction.ADD_MANY_NODES, { entities, position });

/**
 * @deprecated
 */
export const addNestedNode = (parentNodeID: string, node: Creator.NodeDescriptor, data: Creator.DataDescriptor): AddNestedNode =>
  createAction(SocketAction.ADD_NESTED_NODE, { parentNodeID, node, data });
 ...
 * @deprecated
 */
export const removeManyOutByKeyPorts = (ports: { key: string; portID: string }[]): RemoveManyOutByKeyPorts =>
  createAction(SocketAction.REMOVE_MANY_OUT_BY_KEY_PORTS, ports);
 ...
 * @deprecated
 */
export const removeManyLinks = (linkIDs: string[]): RemoveManyLinks => createAction(SocketAction.REMOVE_MANY_LINKS, linkIDs);
