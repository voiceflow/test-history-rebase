...
export const getActiveVersionContext = (): SyncThunk<NonNullableRecord<ActiveVersionContext>> => (_dispatch, getState) => {
  const context = activeVersionContextSelector(getState());
