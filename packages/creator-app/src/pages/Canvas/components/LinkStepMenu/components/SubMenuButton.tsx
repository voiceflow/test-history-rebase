...
import { Box, MenuItem, Portal, SvgIcon, SvgIconTypes, TippyTooltip, usePopper } from '@voiceflow/ui';
...
const SubMenuButton: React.FC<SubMenuButtonProps> = ({ step, template }) => {
  ...
  return (
    ...
    >
      <Box.FlexStart width="100%">
        ...
        <StyledText disabled={isLocked as boolean}>
          {step && step.label}
