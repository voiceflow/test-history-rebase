...
const HelpTooltip: React.FC = () => (
  <>
    ...
    <Tooltip.Paragraph marginBottomUnits={3}>
      ...
      {'{user_name}'} and then use the user’s name in your skill using a speak block to better personalize the experience. If the user says a number,
      such as ‘six’, the response will automatically be converted to a number format (‘six’ turns to ‘6’) to allow you to capture and use numbers.
    </Tooltip.Paragraph>
