...
const DisplayEditorRoot: NodeEditorV2<Realtime.NodeData<BaseNode.Visual.APLStepData>, Realtime.NodeData.VisualBuiltInPorts> = () => {
  const editor = EditorV2.useEditor<Realtime.NodeData<BaseNode.Visual.APLStepData>, Realtime.NodeData.VisualBuiltInPorts>();
  const { data } = editor;
...
export default DisplayEditorRoot;
