...
import { CustomAPITestResponse, CustomAPITestResponseMetadata } from '../types';
...
export const mapTestResponse = (response: AxiosResponse<any, any>, initTime: number): CustomAPITestResponse => ({
...
export const mapTestResponseError = (error: any, initTime: number): CustomAPITestResponse => {
