...
const FlowStartBlock: React.ForwardRefRenderFunction<BlockAPI, FlowStartBlockProps> = ({ label, portID, commands, variant, ...props }, ref) => (
  <BlockWithCommands {...props} className={FLOW_BLOCK_CLASSNAME} commands={commands} ref={ref} variant={variant}>
    <FlowStartStep label={label} portID={portID} variant={variant} />
  </BlockWithCommands>
);
