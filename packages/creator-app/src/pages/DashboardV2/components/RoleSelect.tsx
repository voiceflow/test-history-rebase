...
import { Checkbox, CheckboxTypes, createDividerMenuItemOption, defaultMenuLabelRenderer, Select, UIOnlyMenuItemOption } from '@voiceflow/ui';
...
const RoleSelect: React.FC<RoleSelectProps> = ({ roles, isInvite, onChange, onRemove, onResendInvite }) => {
  ...
  const getOptions = () => {
    ...
    if (onRemove || onResendInvite) {
      opts.push(createDividerMenuItemOption('divider-1'));
    }
