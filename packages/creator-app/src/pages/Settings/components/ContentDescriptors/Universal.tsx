...
const ContinuePrevious: React.OldFC = () => (
  <DescriptorContainer>
...
const DefaultVoice: React.OldFC = () => <DescriptorContainer>The default text-to-speech voice used across your assistant.</DescriptorContainer>;
