...
const Diagram = lazy(() => import(/* webpackPrefetch: true */ './components/DiagramV2'));
const Business = lazy(() => import('@/pages/Business'));
const Migrate = lazy(() => import('@/pages/Migrate'));
const Publish = lazy(() => import('@/pages/Publish/indexV2'));
const Settings = lazy(() => import('@/pages/Settings/indexV2'));
