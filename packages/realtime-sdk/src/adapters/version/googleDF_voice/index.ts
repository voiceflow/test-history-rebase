...
const googleDFVoiceVersionAdapter = createAdapter<GoogleDFVersion.GoogleDFESVersion, Version<GoogleDFVersion.GoogleDFESVersionData>>(
  ({
    variables,
    platformData: {
...
export default googleDFVoiceVersionAdapter;
