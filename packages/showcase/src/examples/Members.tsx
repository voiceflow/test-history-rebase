...
const normal = createExample(
  'normal',
  wrapContainer(() => <Members members={members} />)
);

const flat = createExample(
  'flat',
  wrapContainer(() => <Members members={members} flat />)
);

const small = createExample(
  'small',
  wrapContainer(() => <Members members={members} small />)
);

const withButton = createExample(
  'withButton',
  wrapContainer(() => <Members members={members} onAdd={() => {}} />)
);

export default createSection('Members', 'src/components/Members/index.tsx', [normal, flat, small, withButton]);
