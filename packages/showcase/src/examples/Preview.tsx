...
const speakPreview = createExample(
  'prompt list',
  <Preview>
    <Preview.Header>
...
const entityPreview = createExample(
  'list with tag',
  <Preview>
    <Preview.Header>
...
const urlPreview = createExample(
  'simple preview',
  <Preview>
    <Preview.Header>
...
const goToTargetPreview = createExample(
  'different icons',
  <Preview>
    <Preview.Header>
...
const popupPreview = createExample(
  'popup',
  <Preview.Popover>
...
const codePreview = createExample(
  'code',
  <Preview>
    <Preview.Header>
