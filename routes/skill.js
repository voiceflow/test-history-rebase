...
const incrementTimesPublishedIntercom = (id) => {
  ...
  intercom.users.find({
    ...
    const n = res.body.custom_attributes.times_published
...
const incrementTimesPublishedSuccessfulIntercom = (id) => {
  ...
  intercom.users.find({
    ...
    const n = res.body.custom_attributes.times_published_successful
...
const updateDialogflowPackage = ({ private_key, client_email }, google_id, { intents, slots }, locale) => new Promise(async (resolve, reject) => {
  try {
