    ...
    return (
      <Provider store={store}>
        ...
        <Router history={history}>
          <div id="body">
            {this.state.session && history.location.pathname !== "/onboarding" && (
              <Route
                render={props => {
                  return <NavBar {...props} />;
                }}
            ...
            <Switch>
              ...
              {/* Canvas Routes */}
              <PrivateRoute
                path="/preview/:skill_id/:diagram_id"
                component={Skill}
                page="canvas"
              ...
              />
              <PrivateRoute
                path="/canvas/:skill_id/:diagram_id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="canvas"
              />
              <PrivateRoute
                path="/canvas/:skill_id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="canvas"
              />
              {/* Business routes */}
              <PrivateRoute
                path="/business/:skill_id/link_account/templates"
                component={Skill}
                onConfirm={this.onConfirm}
                page="business"
              ...
              />
              <PrivateRoute
                path="/business/:skill_id/email/:id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="business"
                secondaryPage="email"
              />
              <PrivateRoute
                path="/business/:skill_id/emails"
                component={Skill}
                onConfirm={this.onConfirm}
                page="business"
                secondaryPage="emails"
              />
              <PrivateRoute
                path="/business/:skill_id/product/:id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="business"
              ...
              />
              <PrivateRoute
                path="/business/:skill_id/products"
                component={Skill}
                onConfirm={this.onConfirm}
                page="business"
                secondaryPage="products"
              />
              <PrivateRoute
                path="/business/:skill_id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="business"
                secondaryPage="home"
              ...
              {/* Settings routes */}
              <PrivateRoute
                path="/settings/:skill_id/discovery/canfulfill/:id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="settings"
              ...
              />
              <PrivateRoute
                path="/settings/:skill_id/discovery/"
                component={Skill}
                onConfirm={this.onConfirm}
                page="settings"
                secondaryPage="discovery"
              ...
              />
              <PrivateRoute
                path="/settings/:skill_id/advanced/"
                component={Skill}
                onConfirm={this.onConfirm}
                page="settings"
                secondaryPage="advanced"
              />
              <PrivateRoute
                path="/settings/:skill_id/backups/"
                component={Skill}
                onConfirm={this.onConfirm}
                page="settings"
                secondaryPage="backups"
              />
              {/* Admin routes */}
              <PrivateRoute
                path="/visuals/:skill_id/display/:id"
                onConfirm={this.onConfirm}
                component={Skill}
                page="visuals"
                secondaryPage="display"
              />
              <PrivateRoute
                path="/visuals/:skill_id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="visuals"
                secondaryPage="displays"
              />
              <PrivateRoute
                path="/admin/updates"
                name="Admin"
              ...
              />
              <PrivateRoute
                path="/publish/:skill_id/google"
                component={Skill}
                onConfirm={this.onConfirm}
                page="publish"
                secondaryPage="google"
              />
              <PrivateRoute
                path="/publish/:skill_id/alexa"
                component={Skill}
                onConfirm={this.onConfirm}
                page="publish"
                secondaryPage="alexa"
              />
              <PrivateRoute
                path="/publish/:skill_id/market"
                component={Skill}
                onConfirm={this.onConfirm}
                page="publish"
                secondaryPage="market"
              />
              <PrivateRoute
                path="/publish/:skill_id"
                component={Skill}
                onConfirm={this.onConfirm}
                page="publish"
                secondaryPage="alexa"
