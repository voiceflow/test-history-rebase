...
ace.define('ace/mode/slot_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (req, exports) => {
...
ace.define('ace/mode/slot', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/slot_highlight_rules'], (req, exports) => {
  const oop = req('../lib/oop');
