...
const Button = styled.button`
  ...
  &:active {
    ...
    -webkit-box-shadow: 0 0 0 2px rgba(184, 218, 255, 1);
    -moz-box-shadow: 0 0 0 2px rgba(184, 218, 255, 1);
    box-shadow: ${(props) => (props.color ? `0 0 0 1px ${props.color}99` : '0 0 0 1px #fff, 0 2px 4px 1px rgba(17, 49, 96, 0.16)')};
  }
`;

const RoundButton = (props) => {
  const { icon, imgAlt, className, innerRef, onClick, disabled, ...attributes } = props;
  ...
  return (
    <Button {...props} {...attributes} className={className} ref={innerRef} onClick={onBtnClick}>
      <img src={icon} alt={imgAlt || 'button'} width={18} height={18} />
    </Button>
  );
};
