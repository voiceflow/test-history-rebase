...
import IconButtonComponent, * as IconButton from '@/components/IconButton';
...
function Controls() {
  ...
  return (
    ...
    <div onMouseDown={stopPropagation()}>
      <ZoomControls>
        <IconButtonComponent icon="zoomIn" onClick={() => canvas.zoomIn(ZOOM_DELTA)} />
        <IconButtonComponent icon="zoomOut" onClick={() => canvas.zoomOut(ZOOM_DELTA)} />
      </ZoomControls>
      <IconButtonComponent icon="home" onClick={canvas.reorient} />
    </div>
  );
}
...
export const normal = () => {
  ...
  React.useEffect(() => updateState(true), []);
