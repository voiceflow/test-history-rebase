    ...
    return (
      <div className="multiple">
            ...
            <InputGroup>
              {this.props.prepend ? (
                <InputGroupAddon className="input-prepend" addonType="prepend">
                  <InputGroupText className="input-group-text-bg">{this.props.prepend}</InputGroupText>
                </InputGroupAddon>
              ) : null}
              <Input
              ...
              {this.props.list.length > 1 ? (
                <InputGroupAddon addonType="append">
                  <button className="close ml-3" onClick={() => this.delete(i)} />
                </InputGroupAddon>
              ) : null}
            </InputGroup>
          </div>
        ...
        {(this.props.max && this.props.list.length >= this.props.max) || this.props.isDisabled ? null : (
          <Button block outline color="primary" onClick={this.add}>
            {this.props.add}
          </Button>
        )}
      </div>
