    ...
    render() {
      ...
      return (
        <div className="overflow-auto p-2">
          ...
          <p>
              Welcome to the {name} Alexa Skill.
          </p>
          <p>
              At {name}, (“{skill}”), we create Alexa skills to enhance
          ...
          <p>
              ...
              time to time, are a binding contract between {name} (“we” and/or “us”,
              etc) and you ("you”).
          </p>
          <p>
              You may only use the service(s) operated by {name} if you first
          ...
          <p>
              This policy covers how {name} treats personal information that is
              collected or received through the services we provide. Personal information is
          ...
          <p>
              ...
              or control, or to people that we do not employ or manage. Companies such as
          ...
          <p>
              {name} collects personal information when you contract with us to
              use or purchase our services. When you contract with us for a particular service,
              we will ask you to provide us with your name, email address, and a contact phone
              number.
          </p>
          <p>
              The {name} Alexa skill may from time to time collect Skill usage
          ...
          <p>
              {name} uses the information that is collected for the following
              general purposes: to provide updates to you regarding products and services, to
              fulfill your requests for products and services, improve products and
              services, contact you, conduct research, and to optimize and improve the website.
          </p>
          <p>
              OWNERSHIP OF CONTENT
          </p>
          <p>
              You acknowledge and agree that: (i) {name} owns all rights, title
          ...
          <p>
              {name} does not design any part of its Alexa skill to attract
              anyone under age 13. {name} will not knowingly contact children under age 13
              without a parent's permission. {name} does not knowingly ask a
          ...
          <p>
              {name} does not store any data on users under the age of 13.
              Temporary data collected by {name} from users under age 13 is
          ...
          <p>
              {name} does not rent, sell or share personal information about
              you with other people or companies except under the following circumstances:
          </p>
          <p>
