...
function Utterance({ space, value, slots = EMPTY_ARRAY, onChange, onAddSlot, characters = '', forwardedRef }) {
...
const UtteranceWithCatch = lifecycle({
  componentDidCatch() {
    this.forceUpdate();
  },
})(Utterance);
...
// eslint-disable-next-line react/display-name
export default React.forwardRef((props, ref) => <UtteranceWithCatch {...props} forwardedRef={ref} />);
