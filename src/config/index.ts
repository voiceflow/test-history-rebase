...
export const CLOUD_ENV = process.env.VF_OVERRIDE_CLOUD_ENV || process.env.CLOUD_ENV || 'public';
...
export const GENERAL_SERVICE_CLOUD_ENDPOINT = process.env.GENERAL_SERVICE_CLOUD_ENDPOINT!;
