...
export const API_ENDPOINT = `https://${API_HOST}${IS_DEVELOPMENT ? ':8003' : ''}`;
...
// canvas export
export const CANVAS_EXPORT_CLOUD_ENDPOINT = window.VF_OVERRIDE_CANVAS_EXPORT_ENDPOINT || process.env.CANVAS_EXPORT_CLOUD_ENDPOINT!;
export const CANVAS_EXPORT_LOCAL_ENDPOINT = process.env.CANVAS_EXPORT_LOCAL_ENDPOINT!;
export const CANVAS_EXPORT_ENDPOINT = IS_DEVELOPMENT ? CANVAS_EXPORT_LOCAL_ENDPOINT : CANVAS_EXPORT_CLOUD_ENDPOINT;
...
export const GENERAL_RUNTIME_ENDPOINT_TAG = 'GENERAL_RUNTIME_ENDPOINT';
...
export const GENERAL_RUNTIME_ENDPOINT =
  GENERAL_RUNTIME_STORAGE_ENDPOINT || (IS_DEVELOPMENT ? GENERAL_RUNTIME_LOCAL_ENDPOINT : GENERAL_RUNTIME_CLOUD_ENDPOINT);

if (!GENERAL_RUNTIME_STORAGE_ENDPOINT) {
  localStorage.setItem(GENERAL_RUNTIME_ENDPOINT_TAG, GENERAL_RUNTIME_ENDPOINT);
}
