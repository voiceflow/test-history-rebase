...
// platform services
export const ALEXA_SERVICE_CLOUD_ENDPOINT = process.env.ALEXA_SERVICE_CLOUD_ENDPOINT!;
...
export const GOOGLE_SERVICE_CLOUD_ENDPOINT = process.env.GOOGLE_SERVICE_CLOUD_ENDPOINT!;
...
export const TRUSTED_ENDPOINTS = [API_ENDPOINT, ALEXA_SERVICE_ENDPOINT, GOOGLE_SERVICE_ENDPOINT];
