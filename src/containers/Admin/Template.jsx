      ...
      <div className="fb_wrapper">
        ...
        <div>
          <Form>
            <FormGroup row>
              ...
              <Col sm={2}><Button color="warning" onClick={()=>this.setState(s=>({template:{...s.template, module_id:''}}))}>Clear ID</Button></Col>
            </FormGroup>
            <FormGroup row>
              <Label for="title" sm={2}>Title</Label>
              <Col sm={10}><Input name="title" id="title" value={this.state.template.title} onChange={this.handleInputChange}/></Col>
            </FormGroup>
            <FormGroup row>
              <Label for="descr" sm={2}>Description</Label>
            ...
            <FormGroup row>
              <Label for="project" sm={2}>Project ID</Label>
              <Col sm={10}><Input name="module_project_id" id="project" value={this.state.template.module_project_id} onChange={this.handleInputChange}/></Col>
            </FormGroup>
            <FormGroup row>
        ...
        <Table striped hover>
          ...
          {this.state.templates.map(t=>(
            <tr key={t.module_id}>
              <th scope="row" className="align-middle">{t.module_id}</th>
              <td>{t.title}</td>
              <td>{t.descr}</td>
