  ...
  renderTeams() {
    ...
    return (
      <div className="cl__no_charges">
        ...
        <p>If you have already searched, please wait patiently as the developer of this page was too lazy to detect when loading happens.</p>
      </div>
    );
  }

  render() {
    return <div className="cl__wrapper">{this.renderTeams()}</div>;
  }
}
