...
class ProductDetailsForm extends React.Component {
  render() {
    return (
      <AvForm onValidSubmit={this.props.submit} onInvalidSubmit={() => this.props.updateStage(4)}>
        <AvGroup>
          <label>
            Keywords &nbsp;
        ...
        <div className="product-stage-button">
          <Button type="button" isFlatGray className="mr-2" variant="contained" onClick={() => this.props.updateStage(3)}>
            Previous
          </Button>
