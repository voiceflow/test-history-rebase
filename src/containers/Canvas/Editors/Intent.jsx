        ...
        <div className={this.props.live_mode ? 'disabled-overlay' : null}>
          ...
          {this.props.platform !== 'google' && this.state.isRoot && intent && this.state.tab === 'Select' && (
            <div>
              ...
              {checked && this.state.node.extras.intent && hasSlots(this.state.node.extras.intent) && (
                <button
                  className="btn btn-clear btn-shadow w-100 my-2 d-flex space-between fulfill-label"
                  onClick={() => {
                    this.props.history.push(
                      `/settings/${this.props.skill_id}/discovery/canfulfill/${
                        this.state.node.extras.intent ? this.state.node.extras.intent.key : ''
                      }`
                    );
                  }}
                >
