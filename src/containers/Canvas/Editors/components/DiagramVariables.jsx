...
const DiagramVariables = (props) => (
  <>
        ...
        <div key={i} className="super-center mb-2">
          ...
          >
            <Select
              ...
              options={
                Array.isArray(props.arg1_options)
                  ? props.arg1_options.map((variable, idx) => {
            ...
            <Select
              ...
              options={
                Array.isArray(props.arg2_options)
                  ? props.arg2_options.map((variable) => {
                      return { label: `{${variable}}`, value: variable };
                    })
                  : null
              }
          ...
          <Button isFloat onClick={() => props.onRemove(i)}>
            &times;
          </Button>
        </div>
      );
    ...
    <Button isBtn isClear isLarge isBlock onClick={props.onAdd}>
      <i className="far fa-plus mr-1" /> Add Variable Map
    </Button>
  </>
);
