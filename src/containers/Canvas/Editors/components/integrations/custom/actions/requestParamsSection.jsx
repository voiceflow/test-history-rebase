            ...
            <div className="align-self-center">
              <Nav tabs className="mb-3">
                ...
                <NavItem
                  className="mr-2"
                  onClick={() => {
                    if (this.props.selected_action !== C.GET_REQUEST) this.setState({ type: 'body' });
                  }}
                >
                  <NavLink href="#" active={this.state.type === 'body'} disabled={this.props.selected_action === C.GET_REQUEST}>
                    Body
                  </NavLink>
                </NavItem>
