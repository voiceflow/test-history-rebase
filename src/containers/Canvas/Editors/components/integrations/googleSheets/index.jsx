...
class GoogleSheets extends IntegrationBase {
  constructor(props) {
    ...
    this.integration_info = {
      actions: {
        [C.RETRIEVE_DATA]: {
          sections: [C.ACTIONS_SECTION, C.USER_SECTION, C.SPREADSHEET_SECTION, C.RETRIEVE_OPTIONS_SECTION, C.OUTPUT_SECTION, C.TESTING_SECTION],
          tooltip: 'Retrieve a Single Row from a Spreadsheet',
        },
        [C.CREATE_DATA]: {
          sections: [C.ACTIONS_SECTION, C.USER_SECTION, C.SPREADSHEET_SECTION, C.CREATE_OPTIONS_SECTION, C.TESTING_SECTION],
          tooltip: 'Create a Row in a Spreadsheet',
        },
        [C.UPDATE_DATA]: {
          sections: [C.ACTIONS_SECTION, C.USER_SECTION, C.SPREADSHEET_SECTION, C.UPDATE_OPTIONS_SECTION, C.TESTING_SECTION],
          tooltip: 'Update an Existing Row in a Spreadsheet',
        },
        [C.DELETE_DATA]: {
          sections: [C.ACTIONS_SECTION, C.USER_SECTION, C.SPREADSHEET_SECTION, C.DELETE_OPTIONS_SECTION, C.TESTING_SECTION],
          tooltip: 'Delete Rows in a Spreadsheet',
        },
      },
      addUserModal: GoogleAddUserModal,
    };
    this.actionsRequiringConfirm = [C.UPDATE_DATA, C.DELETE_DATA];
  }
  ...
  updateHeaders = async () => {
    ...
    try {
      const headers = await IntegrationsService.googleSheets.getSheetHeaders(
        spreadsheet_id,
        sheet_id,
        integrationsUser,
        this.props.user.creator_id,
        this.props.skill_id
      );
