...
const blocks = [
  {
    type: 'speak',
    info:
      'Speak blocks allow you to get Alexa to talk to the user. You can enter an unlimited amount of text, and even add variables in the text to have Alexa say the user’s names, or any other captured variable.',
  ...
  },
  {
    type: 'command',
    info:
      'The command block allows the user to access global commands across your whole skill. At any point, a user can ask for a command block that you create such as ‘STOP’ or ‘HOME’ and the command block associated with that command will be activated, no matter where they are in your skill’s flow.',
