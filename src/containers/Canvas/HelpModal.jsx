...
const blocks = [
  ...
  },
  {
    type: 'command',
    info:
      'Commands can be accessed by the user from anywhere in your skill. For example, if a user says "Alexa, help" while in your skill, they will activate the help flow. Once a user is done with the help flow, they will be returned to wherever they previously were in the skill.',
  ...
  },
  {
    type: 'if',
    info:
      'IF blocks allow you to choose a path for the user based on if a condition is true, or false. As an example, you can set an IF block to see if ‘variable = 5’. If the variable you selected is equal to 5, then the IF block will follow the true path. If the statement is false, the IF block will follow the false path.',
