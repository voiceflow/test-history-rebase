      ...
      return (
        ...
        <span className="text-muted text-center">
          ...
          <div className="my-3">
            ...
            <a href={`http://university.voiceflow.com/voiceflow-tutorials/google-assistant/deploying-your-google-assistant-project-to-production`}
                  ...
                  <div className="big-settings-content">
                      ...
                      <div className="row">
                        <div className="col-3 publish-info">
                          <p className="helper-text">
                            Your <b>Dialogflow Credentials File</b> for publishing. Instructions can be found <a href="http://university.voiceflow.com/voiceflow-tutorials/google-assistant/uploading-your-project-to-google-assistant" target="_blank" className="google-link" rel="noopener noreferrer">here</a></p>
                        </div>
                        <div className="col-9">
                    ...
                    {this.state.credentials &&
                      <div className="row">
                        ...
                        <div className="col-9">
                          <Button className="w-100" color="danger" onClick={this.onUnlinkClick}>{this.state.unlink_loading ? <span className="loader"></span> : 'Unlink Google Project'}</Button>
                        </div>
                      </div>}
                  </div>
                </div>
