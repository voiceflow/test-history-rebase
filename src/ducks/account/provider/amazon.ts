...
export const linkAccount = (code: string): Thunk<Nullable<Account.Amazon>> => async (dispatch) => {
  try {
...
export const activateVendor = (vendorID: string): Thunk => async (dispatch, getState) => {
