...
export const allSlotsByIntentIDSelector = createSelector(intentByIDSelector, (getIntentByID) => (id) => {
...
export const allPlatformIntentsSelector = createSelector(allIntentsSelector, activePlatformSelector, (intents, platform) =>
...
export const platformIntentByIDSelector = createSelector(mapPlatformIntentsSelector, (intentsMap) => (id) => intentsMap[id]);

export const allSlotsIDsByIntentIDsSelector = createSelector(allSlotsByIntentIDSelector, (getSlotIDsByIntentID) => (intentIDs) =>
  Array.from(
...
export const intentSlotByIntentIDSlotIDSelector = createSelector(intentByIDSelector, (getIntentByID) => (intentID, slotID) => {
