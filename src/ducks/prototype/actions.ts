...
import { Context, PrototypeState, PrototypeStatus, Store, StoreType } from './types';
...
export type AnyPrototypeAction = UpdatePrototype | UpdatePrototypeStatus | UpdatePrototypeContext | UpdatePrototypeContextStore;
