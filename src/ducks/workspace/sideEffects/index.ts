...
export const loadWorkspaces = (isPublicUser = false): Thunk => async (dispatch) => {
  try {
...
export const patchActiveWorkspace = (payload: Partial<Workspace>): SyncThunk => (dispatch, getState) => {
...
export const updateActiveWorkspaceMembers = (members: DBWorkspace.Member[]): Thunk => async (dispatch, getState) => {
  try {
    const activeWorkspaceID = Session.activeWorkspaceIDSelector(getState());
    const body = {
...
export const updateActiveWorkspaceName = (name: string): Thunk => async (dispatch, getState) => {
  try {
    const activeWorkspaceID = Session.activeWorkspaceIDSelector(getState());
...
export const updateActiveWorkspaceImage = (url: string): Thunk => async (dispatch, getState) => {
  try {
    const activeWorkspaceID = Session.activeWorkspaceIDSelector(getState());
...
export const ejectFromActiveWorkspace = (workspaceID: string, workspaceName: string): Thunk => async (dispatch, getState) => {
...
export const importProjectToActiveWorkspace = (projectID: string, workspaceID: string): Thunk<AnyProject> => async (dispatch, getState) => {
