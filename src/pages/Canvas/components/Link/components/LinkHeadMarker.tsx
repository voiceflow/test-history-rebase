...
const LinkHeadMarker: React.FC<LinkHeadMarkerProps> = ({ id, isHighlighted, color = isHighlighted ? HIGHLIGHT_COLOR : DEFAULT_COLOR }) => (
  <marker id={id ? `head-${id}` : 'head'} viewBox="0 0 20 20" refX="8" refY="4" markerWidth="20" markerHeight="20" markerUnits="userSpaceOnUse">
    <path
