...
function AdvancedEditorV2({ jsonFileName, onChange, aplCommands = '', document: documentData, datasource = '' }) {
  const removeFile = () => {
    onChange({ jsonFileName: null, displayID: null, dataSource: null, document: null });
  };
...
export default AdvancedEditorV2;
