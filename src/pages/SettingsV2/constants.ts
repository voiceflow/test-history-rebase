...
import AlexaFeatures from '@/pages/SettingsV2/components/SettingsContent/Sections/ChannelSpecificFeatures/AlexaFeatures';

import { Alexa, General, Google, Universal } from './components/ContentDescriptors';
import { Basic, DangerZone, GlobalConversationLogic } from './components/SettingsContent/Sections';
...
export const SectionComponents = <Record<SettingSections, React.FC>>{
