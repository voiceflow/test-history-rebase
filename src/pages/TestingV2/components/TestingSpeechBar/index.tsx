...
export type TestingSpeechBarProps = {
  locale: string;
  isPublic?: boolean;
...
const TestingSpeechBar: React.FC<ReactSpeechRecognitionProps & TestingSpeechBarProps> = ({
  locale,
  isPublic,
  listening,
  transcript,
...
export default withSpeechRecognition({ autoStart: false })(TestingSpeechBar);
