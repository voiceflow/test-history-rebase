...
const createGetter = <T extends keyof MutableStore>(key: T) => (): MutableStore[T] => MUTABLE_STORE[key];

const createSetter = <T extends keyof MutableStore>(key: T) => <V extends MutableStore[T]>(value: V): V =>
