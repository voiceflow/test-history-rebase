...
t mapStateToProps = state => ({
    l: state.skills.skill,
    platform: state.skills.skill.platform,
    ram_id: state.skills.skill.diagram,
        e: state.skills.live_mode,
            
                
                     = dispatch => {
                    
                    pe, val) => dispatch(updateVersion(type, val)),
                     dispatch(setError(err)),
                    e: (val) => dispatch(updateLocales(val)),
                    ish, cb) => dispatch(updateSkillDB(publish, cb))
                    
                
            onnect(mapStateToProps, mapDispatchToProps)(ActionGroup);
