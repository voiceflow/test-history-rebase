...
const BLOCK_TYPES = {
    ...
    'intent': { text: 'Jump', type: 'intent', icon: <i class="fas fa-arrow-alt-from-left"/>, tip: 'Handle intents, from within the skill and upon skill launch with CanFulfillIntent)'},
    ...
    'card': { text: 'Card', type: 'card', icon: <i class="fas fa-poll-h"></i>, tip: 'Tell Alexa to show a card'  },
    'display': { text: 'Display', type: 'display', icon: <i class="fas fa-image"></i>, tip: 'Show a Multimodal Display on the screen using APL' },
