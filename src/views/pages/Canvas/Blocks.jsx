...
const BLOCK_TYPES = {
    ...
    'intent': { text: 'Intent', type: 'intent', icon: <i class="fas fa-arrow-alt-from-left"/>, tip: 'Handle intents, from within the skill and upon skill launch with CanFulfillIntent)'},
    ...
    'card': { text: 'Card', type: 'card', icon: <i className="fas fa-poll-h"></i>, tip: 'Tell Alexa to show a card'  },
