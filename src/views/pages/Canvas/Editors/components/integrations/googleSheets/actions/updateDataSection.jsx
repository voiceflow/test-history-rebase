    ...
    return (
      <>
        ...
        {this.props.action_data.row_values && <Collapse isOpen={this.props.open} className='w-100'>
          {!this.props.headers_loading && this.props.sheet_headers && <div className='d-flex flex-column'>

            <div className='d-flex flex-row w-100 align-items-center'>
              <div className="mr-2 text-muted" style={{ whiteSpace: "nowrap" }}>Row Number</div>
