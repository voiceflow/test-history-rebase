      ...
      content = (
        <div className="MUIform">
          {this.state.stage_error && this.state.stage_error.stage === 2 ? (
            <Alert color="danger">{this.state.stage_error.message}</Alert>
          ) : null}
          {[
            {
              value: "purchase",
              ...
              <Form>
                <div className="big-settings-alignment-div">
                  <div className="mb-3 mt-5">
                    <label className="dark">Basic Skill Info</label>
                  </div>
                ...
                <div className="big-settings-alignment-div">
                  <div className="mb-4">
                    <label className="dark">Skill Description</label>
                  </div>
                  <div className="big-settings-content">
                ...
                <div className="big-settings-alignment-div">
                  <div className="mb-4">
                    <label className="dark">Skill Invocation</label>
                  </div>
                  <div className="big-settings-content">
                    <FormGroup>
                      <div className="row">
                ...
                <div className="big-settings-alignment-div">
                  <div className="mb-4">
                    <label className="dark">Locales</label>
                  </div>
                  <div className="big-settings-content">
                    <FormGroup className="mt-0">
                      <div className="row">
                ...
                <div className="big-settings-alignment-div">
                  <div className="mb-4">
                    <label className="dark">Privacy and Terms</label>
                  </div>
                  <div className="big-settings-content">
                    <FormGroup>
