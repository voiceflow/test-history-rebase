...
import AudioController, { TAudio } from '@/pages/TestingV2/TestTool/Audio';

suite('TestingV2/TestTool/Audio - TAudio', ({ spy, stub, expect }) => {
  describe('TAudio', () => {
...
suite('TestingV2/TestTool/Audio', ({ stub, expect }) => {
  beforeEach(() => {
